...
#define pBUZER			12
#define TIME_BEEP_H		1 			// 20ms
#define TIME_BEEP_L		200			// 100ms
...
// Battery voltage
#define pVIN			A11
#define VOLTAGE_USB		80			// In raw units of analogRead()
...
#define UPDATE_GUI_INTERVAL	1000	// Time to update GUI (constantly)
